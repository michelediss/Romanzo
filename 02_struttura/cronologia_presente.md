...
### Giorni -15 / -12 — Rumore di fondo

Funzione: stabilire il mondo dopo la Battaglia.
...
- SubBasso come zona apparentemente più libera;
...
### Giorno -6 — Sarnelli avverte Elia
...
### Giorno -5 — De Bonis si avvicina

Funzione: mostrare che Elia è leggibile anche quando tace.

De Bonis non chiede la cosa centrale. Nomina persone e ambienti di lato, osservando le reazioni di Elia.
...
Il corpo emotivo del romanzo arriva qui. Non deve diventare una scena spettacolare. Deve restare ambigua, sporca, non completamente appropriabile da nessuna versione.
...
SubBasso perde compattezza. Le versioni esplodono. Sarnelli non sa cosa possa essere scritto senza tradirla. De Bonis capisce che il silenzio si è rotto.
...
L’arresto arriva freddo, dopo il colpo emotivo. Può essere mostrato direttamente o tramite notizia, immagine, comunicato, voce.

---

### Giorno +4 — Le versioni
...
La timeline può essere compressa in circa due settimane o allargata a tre-quattro settimane.

- Versione compressa: più trappola, più pressione.
- Versione allargata: più spazio per personaggi laterali e memoria della Battaglia.
