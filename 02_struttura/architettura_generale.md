...
> Sezione strutturale della bibbia. Questo file definisce la forma del romanzo, il rapporto tra presente narrativo, passato traumatico, frammenti d’archivio e rivelazioni.

---

## 1. Principio architettonico

Il romanzo non procede come un’indagine classica, ma come una **ricostruzione progressiva di una rete di fiducia bruciata**.
...
La forma principale è **terza persona stretta su Elia**.

Il romanzo non deve sapere più di Elia in modo esplicito, ma può costruire situazioni in cui il lettore intuisce qualcosa prima di lui.
...
- Ha già avuto luogo prima dell’inizio.
...
## 4. Linee di sfondo che tengono insieme il sistema

### La scena notturna come infrastruttura

Non è una trama autonoma. È un’infrastruttura.
...
- ambigua;
- non spettacolare;
- socialmente leggibile;
- giudiziariamente opaca.
...
## 7. Principio di rivelazione

Le rivelazioni non devono arrivare come spiegazioni frontali, ma come correzioni di interpretazione.
...
## 8. Funzione dei frammenti d’archivio

I frammenti in prima persona non devono spiegare la trama. Devono mostrare Elia che prova a montarla.

Possibili funzioni:

- aprire una parte;
- correggere una scena appena letta;
- dare un lessico privato;
