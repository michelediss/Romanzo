# Rivelazioni e misteri

> File di controllo per gestire cosa sa il lettore, cosa sa Elia, cosa sanno gli altri personaggi e quando una verità cambia significato retroattivamente.

---

## 1. Principio generale

Il romanzo non deve funzionare come un giallo classico.

I misteri non sono enigmi da risolvere, ma **versioni parziali da correggere**.
...
## 2. Misteri principali

### 2.1 Che cosa è successo nella Battaglia?

#### All’inizio

Il lettore sa solo che c’è stata una rottura violenta tra territorialisti e nomadi.

#### Elia

Elia sa più di quanto dice a sé stesso.

#### Rivelazione progressiva

- prima: la Battaglia come trauma collettivo;
- poi: Elia come sopravvissuto a metà;
- poi: Elia come persona che ha visto qualcosa;
- poi: Elia come persona che ha contribuito a una versione parziale;
- infine: Elia come garante già da allora.
...
Per amore, dipendenza, ingenuità o immobilità.
...
- non sa quanto poco valga quella reputazione davanti al sistema duro.

#### Funzione

La sua permanenza deve essere una scelta tragica, non passività.

---

### 2.5 Chi sono i sardi?
...
Elia li vede senza capirli.

#### Rivelazione

Il lettore deve poter ripensare a quella sera più avanti e dire: erano già loro.

#### Funzione

Il mito politico deve entrare anti-epicamente.
...
Sembrano due ragazze sedotte da un’estetica radicale.

#### Verità più interessante

Sono sedotte, sì, ma anche intelligenti. Vogliono rendere reale qualcosa che attorno a loro viene solo nominato.

#### Rivelazione

La richiesta a Elia non deve sembrare stupida. Deve sembrare logica dentro la loro visione del mondo.
...
Vuole una cornice vincente.

Gli interessano le reti, le porte, i passaggi, le contiguità. Non gli basta un fatto: vuole una versione che renda il movimento attaccabile.
...
- Elia può ancora entrare;
- questo lo rende sospetto.

Non rivelare:

- che cosa ha fatto Elia;
- chi ha colpito chi;
- quali versioni sono false.
...
- climax emotivo;
- uso istituzionale del caos;
- crollo delle versioni private.
...
- il costo umano della rete;
- la freddezza della versione istituzionale;
- la povertà della verità finale di Elia;
- il fallimento di tutte le narrazioni complete.

---

## 5. Regole di gestione del mistero
...
## 8. Frase di controllo

> Il mistero non è la verità nascosta. Il mistero è il momento in cui ognuno ha deciso che gli conveniva non vederla.
